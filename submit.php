            ...
            <input type="text" name="userid" value="<?php echo Session::get('uid'); ?>" style="display:none" id="#">
                ...
                <div class="bedbath">
                    <div class="input-container bedbath-container">
                        ...
                        <input type="number" name="bedroom" id="#" required>
                    </div>
                    <div class="input-container bedbath-container">
                        <legend>Bathroom <span class="starsign">*</span></legend>
                        <input type="number" name="bathroom" id="#" required>
                    </div>
                </div>
                ...
                <div class="input-container">
                    <legend>Google Map Embed Link<span class="optional">(optional)</span></legend>
